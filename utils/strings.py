...
questions = [
    ...
    {'id': 'question_05',
     'query': 'Which section of the Criminal Code in WA states the penalty for anyone who is preventing birth of live child?',
    ...
    {'id': 'question_07',
     'query': 'Which section of the Criminal Code states about the penalty for stalking with intent to intimidate a person?',
     'ref_answer': V2_1_legal_llm_responses['question_07']},
    {'id': 'question_08',
     'query': 'What does the law state about the penalty for indecent act in public in WA?',
     'ref_answer': V2_1_legal_llm_responses['question_08']},
    {'id': 'question_09',
     'query': 'Which section of the criminal code states the penalty for distributing child exploitation material in WA?',
     'ref_answer': V2_1_legal_llm_responses['question_09']},
    {'id': 'question_10',
     'query': 'Which section of the law in WA specifies the fine for possessing bulletproof clothing?',
    ...
    {'id': 'question_25',
     'query': 'According to which section does a person who uses the vehicle on a road commit an offence by Road Traffic law in WA?',
     'ref_answer': V2_1_legal_llm_responses['question_25']},
    {'id': 'question_26',
     'query': 'Which section states about the free vehicle licences for certain overseas vehicles, according to the Road Traffic law in WA?',
    ...
    {'id': 'question_33',
     'query': 'Which section of the Criminal Code Law in WA states the penalty for causing explosion likely to do serious injury to property?',
