...
questions = [
    ...
    {'id': 'question_04',
     ...
     'ref_answer': legal_llm_responses['question_04']},
    {'id': 'question_05',
     'query': 'Which section of the Criminal Code in WA states about Fraud?',
     'ref_answer': legal_llm_responses['question_05']},
    {'id': 'question_06',
    ...
    {'id': 'question_27',
     ...
     'ref_answer': legal_llm_responses['question_27']},
    {'id': 'question_28',
     'query': 'Which section of the Road Traffic Law in WA specifies the duty of a driver?',
     'ref_answer': legal_llm_responses['question_28']},
    {'id': 'question_29',
